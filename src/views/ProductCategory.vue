      ...
      <div class="hc-layout-aside-main grid grid-2 grid-gap-responsive">
        <aside class="hc-aside">
          <div class="hc-aside-topics mb-5">
            <h5 class="text-primary-lighter">Topics</h5>
        ...
        <div class="hc-main">
          <h1 class="text-primary-lighter mb-3">Knowledge Base</h1>
...
export default {
  ...
  data: function () {
    return {
      ...
      topics: [
        { heading: 'What\'s New' },
        { heading: 'Installing & Setting Up Matters' },
        { heading: 'Cards' },
        { heading: 'Calendar & Tasks' },
        { heading: 'Time & Fee Recording' },
        { heading: 'Guides & Precedences' },
        { heading: 'Office Accounting' },
        { heading: 'Trust Accounting' },
